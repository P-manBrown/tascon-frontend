...
export function useEditableText<T extends FieldValues>({
  ...
  const handleFormSubmit: FormSubmitHandler<T> = useCallback(
    // biome-ignore lint/suspicious/noExplicitAny: TEMP: Fix by making UseEditableTextParams generic with T; useForm infers unknown from z.core.$ZodType<unknown, FieldValues>, making SubmitHandler<T> incompatible with the inferred SubmitHandler<unknown>
