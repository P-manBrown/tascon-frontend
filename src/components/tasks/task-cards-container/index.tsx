...
export function TaskCardsContainer({
  ...
  return (
    <div
      className={`flex flex-col border border-gray-300 bg-theme ${className}`}
    >
      <div className="flex h-12 shrink-0 items-center justify-between border-gray-300 border-b"></div>
      <div
      ...
      <div className="relative flex h-12 shrink-0 items-center justify-center border-gray-300 border-t">
        {!isReadonly && (
          <Link
            href={{
