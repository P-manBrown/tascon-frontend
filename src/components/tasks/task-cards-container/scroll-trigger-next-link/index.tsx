...
export function ScrollTriggerNextLink({
  ...
  return (
    <Link
      ...
      className="flex h-11 w-full justify-between overflow-hidden rounded-lg border-2 border-gray-300 border-dashed text-gray-600 text-sm transition-all duration-200 hover:bg-green-500/20!"
